...
export default function ShareCard({
  ...
  const handleShare = () => {
    const tweet = `🚀 Just analyzed my wallet on Base Atlas

🏆 Atlas Score: ${score}
🧬 Archetype: ${archetype}

Discover your onchain identity on Base.
...
#Base #BuildOnBase`;
  ...
  return (
    <div>
      ...
      <button
        onClick={handleShare}
        className="mt-4 rounded-2xl bg-[#0052FF] px-6 py-3 font-semibold text-white transition hover:scale-105"
      >
        Share on X
      </button>
    </div>
